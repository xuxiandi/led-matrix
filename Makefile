...
#
# Modified by Lucas Murray <lmurray@undefinedfire.com>
#
...
#     main.cpp file in the folder that already contains the required
#     preprocessing that the Arduino IDE usually does.
#
...
applet_files: main.cpp
	test -d build || mkdir build
	cp main.cpp build/$(TARGET).cpp
...
build/$(TARGET).elf: main.cpp build/core.a
